...
resource "null_resource" "cluster" {
  ...
  provisioner "file" {
    content = templatefile("${path.module}/inventory.tpl", {
      ...
      home_nfs_target_ip             = var.home_nfs_target_ip,
      add_nfs                        = var.add_nfs,
      add_juicefs                    = var.add_juicefs,
      add_apps_nfs                   = var.add_apps_nfs,
      apps_nfs_source_IP             = var.apps_nfs_source_IP,
      add_scratch_nfs                = var.add_scratch_nfs,
      scratch_nfs_source_IP          = var.scratch_nfs_source_IP,
      add_lfs                        = var.add_lfs,
      lfs_target_path                = var.lfs_target_path,
      lfs_source_IP                  = var.lustre_IP,
      ...
      freeipa_server                 = var.freeipa_server,
      freeipa_realm                  = var.freeipa_realm,
      freeipa_domain                 = var.freeipa_domain,
      freeipa_enroll_principal       = var.freeipa_enroll_principal,
      freeipa_enroll_password        = var.freeipa_enroll_password,
      cluster_name                   = local.cluster_name,
