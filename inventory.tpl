...
freeipa_enroll_principal=${freeipa_enroll_principal}
freeipa_enroll_password='${freeipa_enroll_password}'
...
add_apps_nfs=${add_apps_nfs}
apps_nfs_source_IP=${apps_nfs_source_IP}
add_scratch_nfs=${add_scratch_nfs}
scratch_nfs_source_IP=${scratch_nfs_source_IP}
add_juicefs_nfs=${add_juicefs_nfs}
add_lfs=${add_lfs}
